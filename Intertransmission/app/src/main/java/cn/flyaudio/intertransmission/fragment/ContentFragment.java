...
import cn.flyaudio.intertransmission.Views.SendFileListPopWin;
import cn.flyaudio.intertransmission.activity.MainActivity;
import cn.flyaudio.intertransmission.adapter.MyFragmentAdapter;
import cn.flyaudio.intertransmission.p2p.WifiP2pHelper;
import cn.flyaudio.intertransmission.utils.BitmapUtils;
...
public class ContentFragment extends Fragment implements View.OnClickListener, MainActivity.OnSendFileListChangeListener {
    ...
    private MusicFragment fragment_music_make;
    private MovieFragment fragment_video_make ;
    ...
    public void InitViewPager() {
        ...
        fragment_music_make = new MusicFragment();
       fragment_video_make = new MovieFragment();
        ...
        fragmentArrayList.add(fragment_music_make);
        fragmentArrayList.add(fragment_video_make);
