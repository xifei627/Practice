...
import cn.flyaudio.intertransmission.adapter.MyExpandableListViewAdapter;
...
//                recordList.addAll(getGroupRecordFromRecordManager(groups[i]));
            ...
            RecordManager.getInstance(DownloadActivity.this).addOnRecordsChangedListener(this);
            isFirstOnCrate = true;
